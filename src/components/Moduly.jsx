    ...
    <div>
      ...
      <div className="max-xl:px-5">
        <div className="flex flex-col lg:flex-row gap-6 max-w-[1140px] mx-auto max-lg:px-3 pt-[63px]">
          <aside className="w-full gap-2.5 grid grid-cols-1 [@media(min-width:650px)]:grid-cols-2 [@media(min-width:858px)]:grid-cols-3 lg:flex lg:flex-col max-[450px]:max-w-[267px] lg:max-w-[267px] mx-auto">

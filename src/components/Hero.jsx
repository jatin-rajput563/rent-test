        ...
        <div className="max-w-[1440px] relative bg-light-grey mx-auto rounded-[30px] pt-[53px] sm:pt-[77px]">
          ...
          <div>
            <h1 className="text-4xl sm:text-5xl md:text-[56px] lg:text-[64px] hidden lg:block font-bold leading-[120%] text-dark-blue max-w-[860px] text-center mx-auto">
              ...
              <span className="bg-light-purple rounded-tl-xl rounded-bl-xl relative pl-2 ml-1">
                dzięki AI.
                <img
                  className="absolute -top-[32px] pointer-events-none -right-[85px] " src={logoImg} alt="logo-text-img" />
              </span>
            </h1>
          ...
          <div className="min-[769px]:mt-[5.5px]">
            <Swiper
              ...
              breakpoints={{
                1440: { slidesPerView: 5 }, 1280: { slidesPerView: 4 },1024: { slidesPerView: 3.5 },768: { slidesPerView: 2.5 }, 640: { slidesPerView: 2 }, 480: { slidesPerView: 1.5 }, 0: { slidesPerView: 1 },
              }}
              className="mySwiper" >
